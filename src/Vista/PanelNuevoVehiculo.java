    ...
    public void guardar(){
        try {
            if (!marcaTxT.getText().trim().isEmpty() && !tipoVehiculosTxT.getText().trim().isEmpty() && !matriculaTxT.getText().trim().isEmpty() && !colorTxT.getText().trim().isEmpty() && !PrecioTxT.getText().trim().isEmpty()&& !vehiculosDisponiblesTxT.getText().trim().isEmpty()) {
                ctrlVehiculos.getMarca().setMarca(marcaTxT.getText());
                ctrlVehiculos.getMarca().setTipoVehiculo(tipoVehiculosTxT.getText());
                ctrlVehiculos.getAuto().setMatricula(matriculaTxT.getText());
                ctrlVehiculos.getAuto().setColor(colorTxT.getText());
                ctrlVehiculos.getAuto().setPrecio(Double.valueOf(PrecioTxT.getText()));
                ctrlVehiculos.getAuto().setDisponibles(Integer.valueOf(vehiculosDisponiblesTxT.getText()));
                
                Vehiculo auto = new Vehiculo(1, ctrlVehiculos.getMarca(), ctrlVehiculos.getAuto().getColor(), ctrlVehiculos.getAuto().getMatricula(), ctrlVehiculos.getAuto().getPrecio(), ctrlVehiculos.getAuto().getDisponibles());
                ctrlVehiculos.guardar(auto);
    ...
    public void modificar(int pos){
        try {
            if (!marcaTxT.getText().trim().isEmpty() && !tipoVehiculosTxT.getText().trim().isEmpty() && !matriculaTxT.getText().trim().isEmpty() && !colorTxT.getText().trim().isEmpty() && !PrecioTxT.getText().trim().isEmpty()&& !vehiculosDisponiblesTxT.getText().trim().isEmpty()) {
                ...
                Vehiculo auto = new Vehiculo(1, ctrlVehiculos.getMarca(), ctrlVehiculos.getAuto().getColor(), ctrlVehiculos.getAuto().getMatricula(), ctrlVehiculos.getAuto().getPrecio(), ctrlVehiculos.getAuto().getDisponibles());
                ctrlVehiculos.modificar(auto, pos);
